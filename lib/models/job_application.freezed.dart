...
mixin _$JobApplication {
 ...
 String get id; String get jobTitle; String get company; DateTime get dateApplied; ApplicationStatus get status;
...
@override
String toString() {
  return 'JobApplication(id: $id, jobTitle: $jobTitle, company: $company, dateApplied: $dateApplied, status: $status)';
}
...
@useResult
$Res call({
 String id, String jobTitle, String company, DateTime dateApplied, ApplicationStatus status
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String jobTitle,  String company,  DateTime dateApplied,  ApplicationStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JobApplication() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String jobTitle,  String company,  DateTime dateApplied,  ApplicationStatus status)  $default,) {final _that = this;
switch (_that) {
case _JobApplication():
return $default(_that.id,_that.jobTitle,_that.company,_that.dateApplied,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String jobTitle,  String company,  DateTime dateApplied,  ApplicationStatus status)?  $default,) {final _that = this;
switch (_that) {
case _JobApplication() when $default != null:
return $default(_that.id,_that.jobTitle,_that.company,_that.dateApplied,_that.status);case _:
  return null;
...
class _JobApplication implements JobApplication {
  const _JobApplication({required this.id, required this.jobTitle, required this.company, required this.dateApplied, required this.status});
