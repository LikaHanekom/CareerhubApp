...
const JobCacheSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'salary': PropertySchema(id: 7, name: r'salary', type: IsarType.double),
...
void _jobCacheSerialize(
  ...
  writer.writeDouble(offsets[7], object.salary);
...
JobCache _jobCacheDeserialize(
  ...
  object.salary = reader.readDoubleOrNull(offsets[7]);
...
extension JobCacheByIndex on IsarCollection<JobCache> {
  Future<JobCache?> getByJobId(String jobId) {
    return getByIndex(r'jobId', [jobId]);
  }

  JobCache? getByJobIdSync(String jobId) {
  ...
  Future<List<JobCache?>> getAllByJobId(List<String> jobIdValues) {
    final values = jobIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'jobId', values);
  }

  List<JobCache?> getAllByJobIdSync(List<String> jobIdValues) {
    final values = jobIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByJobId(JobCache object) {
    return putByIndex(r'jobId', object);
  }

  Id putByJobIdSync(JobCache object, {bool saveLinks = true}) {
    return putByIndexSync(r'jobId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByJobId(List<JobCache> objects) {
    return putAllByIndex(r'jobId', objects);
  }

  List<Id> putAllByJobIdSync(List<JobCache> objects, {bool saveLinks = true}) {
...
extension JobCacheQueryWhere on QueryBuilder<JobCache, JobCache, QWhereClause> {
  ...
  QueryBuilder<JobCache, JobCache, QAfterWhereClause> jobIdEqualTo(
    String jobId,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<JobCache, JobCache, QAfterWhereClause> jobIdNotEqualTo(
    String jobId,
  ) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
...
extension JobCacheQueryProperty
  ...
  QueryBuilder<JobCache, double?, QQueryOperations> salaryProperty() {
    return QueryBuilder.apply(this, (query) {
